...
public class LookUpAimAlign {
    ...
    static {
        ...
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(4 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 1841.67 / 60.0);
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(5 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 1950.0 / 60.0);
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(6 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2058.33 / 60.0);
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(7 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2166.67 / 60.0);
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(8 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2166.67 / 60.0);
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(9 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2166.67 / 60.0);
        motorSpeedFromDistanceShooting.put(Units.feetToMeters(10 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2220.83 / 60.0);
        ...
        motorSpeedFromDistancePassing.put(Units.feetToMeters(2 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 1625.0 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(3 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 1733.33 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(4 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 1841.67 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(5 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 1950.0 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(6 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2058.33 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(7 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2166.67 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(8 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2166.67 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(9 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2166.67 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(10 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2220.83 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(11 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2275.0 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(12 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2329.17 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(13 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2383.33 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(14 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2491.67 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(15 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2600.0 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(16 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 2816.67 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(17 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 3033.33 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(18 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 3250.0 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(19 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 3358.33 / 60.0);
        motorSpeedFromDistancePassing.put(Units.feetToMeters(20 + BUMPER_TO_TURRET_FT + HALF_HUB_FT), 3466.67 / 60.0);
